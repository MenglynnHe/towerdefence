...
Musiclol::Musiclol(QUrl backgroundMusicUrl,QObject *parent)
    : QObject(parent)
...
void Musiclol::startBGM()
{
    if (m_backgroundMusic)
        m_backgroundMusic->play();
}

void Musiclol::stopBGM(){
    m_backgroundMusic->stop();
}

void Musiclol::playWinSound(){
    if(m_winMusic)
        m_winMusic->play();
}

void Musiclol::playLoseSound(){
    if(m_loseMusic)
        m_loseMusic->play();
}

void Musiclol::playSound(SoundType soundType)
{
...
QMediaPlayer * Musiclol::getMusic(){
